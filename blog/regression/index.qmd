...
To do this, we will use the concept of hypothesis testing. In this test we will have to deal with two types of possible errors:

  - The null hypothesis is rejected even though it is true (type I error)

  - The null hypothesis is not rejected even though it is false (type II error)
